const zh = {
    ...
    mailDomain: '邮箱域名',
    selectDomain: '请选择域名',
    optionalPrefix: '自定义前缀（可选）',
    randomPrefixPlaceholder: '例如 verify-；留空则完全随机',
    randomLength: '随机字符长度',
    previewExample: '地址示例',
    generateMailboxes: '生成随机邮箱',
    codeApiTitle: '验证码取件 URL',
    codeApiDesc: '为现有邮箱创建无需登录即可调用的专属读取地址',
    selectMailbox: '选择邮箱',
    urlLabel: '用途备注',
    urlLabelPlaceholder: '例如：注册测试',
    apiUrlHint: '取件 URL 已包含访问凭证，其他程序可直接通过 GET 调用，请像密码一样妥善保存。',
    createRetrievalUrl: '创建取件 URL',
    refresh: '刷新',
    createdMailboxes: '本次创建的邮箱',
    sharedLoginHint: '这些邮箱共用当前登录账户，但每个邮箱都有独立取件 URL。',
    copyAll: '复制全部',
    downloadCsv: '下载 CSV',
    copySelected: '复制选中',
    exportSelected: '导出选中',
    moreActions: '更多操作',
    filterMailboxPlaceholder: '筛选邮箱、备注或 URL',
    allDomains: '全部域名',
    selectFiltered: '选中筛选结果',
    clearFilteredSelection: '取消筛选选择',
    clearSelection: '清空选择',
    selectedCount: '已选 {count} 个',
    filtered: '个匹配项',
    noFilteredMailboxes: '没有匹配的邮箱',
    selectMailboxRow: '选择邮箱 {email}',
    operation: '操作',
    activeRetrievalUrls: '有效取件 URL',
    activeRetrievalUrlsDesc: '调用地址会返回最近邮件历史，并兼容返回最新验证码；可用游标逐封读取。',
    noRetrievalUrls: '暂无取件 URL',
    unknownMailbox: '未知邮箱',
    createdAt: '创建时间',
    lastCalled: '最近调用',
    retrievalUrl: '取件 URL',
    urlUnavailable: 'URL 暂不可用',
    copyUrl: '复制 URL',
    testFetch: '测试取件',
    revoke: '撤销',
    responseExample: '返回数据示例',
    testFetchResult: '取件测试结果',
    latestVerificationCode: '最新验证码',
    verificationCode: '验证码',
    receivedAt: '接收时间',
    receivedMessageCount: '本次读取 {count} 封邮件',
    messageWithoutCode: '未识别到验证码',
    messageIdLabel: '邮件 ID',
    copyMessages: '复制邮件信息',
    rawResponse: '原始 JSON（调试）',
    copyJson: '复制 JSON',
    batchCreateSuccess: '成功创建 {count} 个邮箱及独立取件 URL',
    prefixNormalized: '前缀中的无效字符已移除',
    retrievalUrlCreated: '取件 URL 已创建',
    revokeUrlConfirm: '确定撤销 {email} 的取件 URL 吗？撤销后原 URL 立即失效。',
    urlRevoked: '取件 URL 已撤销',
    fetchSuccess: '已成功读取验证码',
    noCodeYet: '暂未找到验证码，请先向此邮箱发送验证码邮件',
    requestFailed: '请求失败'
}
export default zh
