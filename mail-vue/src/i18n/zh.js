const zh = {
    ...
    batchMailboxDesc: '一次生成多个随机地址，所有邮件都归当前登录账户管理',
    createCount: '创建数量',
    mailDomain: '邮箱域名',
    selectDomain: '请选择域名',
    ...
    sharedLoginHint: '这些邮箱属于当前登录账户，可在左侧邮箱列表中统一收件。',
    copyAll: '复制全部',
    downloadCsv: '下载 CSV',
    operation: '操作',
    activeRetrievalUrls: '有效取件 URL',
    activeRetrievalUrlsDesc: '调用地址会返回该邮箱最新邮件中识别到的验证码。',
    ...
    batchCreateSuccess: '成功创建 {count} 个邮箱',
