const en = {
    ...
    optionalPrefix: 'Custom prefix (optional)',
    randomPrefixPlaceholder: 'For example, verify-; leave blank for fully random',
    randomLength: 'Random character length',
    previewExample: 'Address preview',
    generateMailboxes: 'Generate Mailboxes',
    codeApiTitle: 'Verification Code URL',
    codeApiDesc: 'Create a dedicated URL that can read an existing mailbox without signing in',
    selectMailbox: 'Select mailbox',
    urlLabel: 'Usage label',
    urlLabelPlaceholder: 'For example: signup tests',
    apiUrlHint: 'The retrieval URL contains its access credential. Other programs can call it directly with GET, so store it like a password.',
    createRetrievalUrl: 'Create Retrieval URL',
    refresh: 'Refresh',
    createdMailboxes: 'Mailboxes Created',
    sharedLoginHint: 'These mailboxes share the current login, but each has its own retrieval URL.',
    copyAll: 'Copy All',
    downloadCsv: 'Download CSV',
    copySelected: 'Copy Selected',
    exportSelected: 'Export Selected',
    moreActions: 'More actions',
    filterMailboxPlaceholder: 'Filter by email, label, or URL',
    ...
    filtered: 'matches',
    noFilteredMailboxes: 'No mailboxes match the current filter',
    selectMailboxRow: 'Select mailbox {email}',
    operation: 'Action',
    activeRetrievalUrls: 'Active Retrieval URLs',
    activeRetrievalUrlsDesc: 'Each URL returns recent message history and remains compatible with the latest-code fields; use the cursor to consume messages one by one.',
    noRetrievalUrls: 'No retrieval URLs yet',
    unknownMailbox: 'Unknown mailbox',
    createdAt: 'Created',
    lastCalled: 'Last called',
    retrievalUrl: 'Retrieval URL',
    urlUnavailable: 'URL unavailable',
    copyUrl: 'Copy URL',
    testFetch: 'Test Retrieval',
    revoke: 'Revoke',
    responseExample: 'Response Example',
    testFetchResult: 'Retrieval Test Result',
    latestVerificationCode: 'Latest verification code',
    verificationCode: 'Verification code',
    receivedAt: 'Received',
    receivedMessageCount: '{count} messages returned',
    messageWithoutCode: 'No verification code recognized',
    messageIdLabel: 'Message ID',
    copyMessages: 'Copy message details',
    rawResponse: 'Raw JSON (debug)',
    copyJson: 'Copy JSON',
    batchCreateSuccess: 'Created {count} mailboxes with independent retrieval URLs',
    prefixNormalized: 'Invalid prefix characters were removed',
    retrievalUrlCreated: 'Retrieval URL created',
    revokeUrlConfirm: 'Revoke the retrieval URL for {email}? The current URL will stop working immediately.',
    urlRevoked: 'Retrieval URL revoked',
    fetchSuccess: 'Verification code retrieved',
    noCodeYet: 'No verification code found. Send a verification email to this mailbox first.',
