const en = {
    ...
    batchMailboxDesc: 'Generate multiple random addresses managed by the current signed-in account',
    ...
    sharedLoginHint: 'These mailboxes belong to the current account and appear together in the mailbox list.',
    copyAll: 'Copy All',
    downloadCsv: 'Download CSV',
    operation: 'Action',
    activeRetrievalUrls: 'Active Retrieval URLs',
    activeRetrievalUrlsDesc: 'Each URL returns the verification code recognized in the latest matching email.',
    ...
    batchCreateSuccess: 'Created {count} mailboxes',
